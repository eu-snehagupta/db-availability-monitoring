...
namespace logReaderMaster.DAL
{
    public class CountryDAL
    {
        ...
        public CountryDAL(IConfiguration iconfiguration) => _connectionString = iconfiguration.GetConnectionString("Default");// Console.WriteLine(_connectionString.Length);
